...
**User Story:** Как создатель КП, я хочу интегрировать видео из Loom, чтобы добавить персонализированные видео-презентации в коммерческое предложение.

#### Критерии приемки

1. WHEN создатель КП вставляет ссылку на Loom-видео, THEN Система SHALL встроить видео-плеер в коммерческое предложение
2. WHEN создатель КП удаляет Loom-видео, THEN Система SHALL удалить встроенный плеер из коммерческого предложения
3. WHEN клиент просматривает КП с Loom-видео, THEN Система SHALL отобразить работающий видео-плеер
